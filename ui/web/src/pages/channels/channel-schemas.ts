...
export const configSchema: Record<string, FieldDef[]> = {
  ...
  slack: [
    ...
    { key: "reasoning_delivery", label: "Show Reasoning", type: "select", options: reasoningDeliveryOptions, defaultValue: "off", help: "Post the model's reasoning into the channel as separate messages. This includes group channels — everyone in the channel sees it, and in a group run the reasoning can quote other participants' messages." },
    { key: "show_placeholder", label: "Show \"Thinking...\" Placeholder", type: "boolean", defaultValue: true, help: "Post a placeholder the answer later edits in place. Turning it off means no receipt until the answer arrives — quick ack is not a substitute, it stays off unless configured. Forced off by Always as bubbles.", disabledWhen: { key: "reasoning_delivery", value: "always_bubbles", hint: "fieldConfig.show_placeholder.disabledHint" } },
